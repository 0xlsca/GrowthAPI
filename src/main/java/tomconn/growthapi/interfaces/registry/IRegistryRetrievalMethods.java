...
public interface IRegistryRetrievalMethods {
     ...
     */
    Predicate<BlockEvent.CropGrowEvent.Pre>[] getRequirementsForCropPre(Class<? extends Block> blockClass);
     ...
     */
    Predicate<SaplingGrowTreeEvent>[] getRequirementsForSapling(Class<? extends Block> blockClass);
