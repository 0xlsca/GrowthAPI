package tomconn.growthapi.implementations.event.helpers.sapling;
 ...
 * @since 0.0.5
 */
public class SaplingGrowTreeEventHelper extends PrimitiveEventHelper< SaplingGrowTreeEvent > {
